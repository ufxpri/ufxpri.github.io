...
exports.onCreateNode = ({ node, actions, getNode, createNodeId, createContentDigest }) => {
  ...
  const { postsPath, pagesPath } = default_option
...
const homepageTemplate = require.resolve(`./page-querys/homepage-query.tsx`)
const blogTemplate = require.resolve(`./page-querys/blog-query.tsx`)
const postTemplate = require.resolve(`./page-querys/post-query.tsx`)
const pageTemplate = require.resolve(`./page-querys/page-query.tsx`)
const tagTemplate = require.resolve(`./page-querys/tag-query.tsx`)
const tagsTemplate = require.resolve(`./page-querys/tags-query.tsx`)

// const homepageTemplate = require.resolve(`./src/components/homepage.tsx`)
// const blogTemplate = require.resolve(`./src/components/blog.tsx`)
// const postTemplate = require.resolve(`./src/components/post.tsx`)
// const pageTemplate = require.resolve(`./src/components/page.tsx`)
// const tagTemplate = require.resolve(`./src/components/tag.tsx`)
// const tagsTemplate = require.resolve(`./src/components/tags.tsx`)

exports.createPages = async ({ actions, graphql, reporter }) => {
  const { createPage } = actions

  const { basePath, blogPath, tagsPath, formatString } = default_option
